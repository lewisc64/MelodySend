...
function getFrequencyFromIndex(i) {
  return frequencies[getNoteFromIndex(i)];
}

function getNoteIndex(note) {
  for (let i = 0; i < order.length; i++) {
    if (typeof order[i] == "string" && order[i] == note || order[i][0] == note || order[i][1] == note) {
      return i;
    }
  }
}
